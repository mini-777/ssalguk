...
function resolveWebOrNativeSpecificEntry(entry) {
  const workspaceRoot = resolve(), resolved = require.resolve(entry, { paths: [workspaceRoot] }), ext = extname(resolved), fileName = basename(resolved).replace(ext, ""), specificExt = "web", specificFile = join(dirname(resolved), fileName + "." + specificExt + ext);
