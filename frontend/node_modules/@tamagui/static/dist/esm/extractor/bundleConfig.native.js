...
async function bundleConfig(props) {
  try {
    ...
    coreComponents && (coreComponents[0].moduleName = "@tamagui/core", components = [...components, ...coreComponents]), process.env.NODE_ENV === "development" && process.env.DEBUG?.startsWith("tamagui") && console.info("Loaded components", components);
    const res = {
      components,
      nameToPaths: {},
