...
async function bundleConfig(props) {
  ...
  try {
    ...
    process.env.NODE_ENV === "development" && ((_a = process.env.DEBUG) != null && _a.startsWith("tamagui")) && console.info("Building config entry", configEntry);
    try {
    ...
    coreComponents && (coreComponents[0].moduleName = "@tamagui/core", components = [...components, ...coreComponents]), process.env.NODE_ENV === "development" && ((_c = process.env.DEBUG) != null && _c.startsWith("tamagui")) && console.info("Loaded components", components);
    const res = {
      components,
      nameToPaths: {},
