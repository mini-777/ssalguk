...
function createAnimations(animations) {
  return {
    ...
    useAnimations: ({ props, presence, style, onDidAnimate }) => {
      ...
      const animateStr = JSON.stringify(animate), styles = (0, import_react.useMemo)(() => JSON.parse(animateStr), [animateStr]), isExiting = !!(presence != null && presence[1]), sendExitComplete = presence == null ? void 0 : presence[1], transition = animations[animationKey], onDidAnimateCombined = (0, import_react.useCallback)(() => {
