...
export declare type MotiTranformProps = Partial<Transforms> & Pick<ViewStyle, 'transform'>;
export declare type TransitionConfigWithoutRepeats = (({
    type?: 'spring';
} & WithSpringConfig) | ({
    type: 'timing';
} & WithTimingConfig) | ({
...
export declare type TransitionConfig = TransitionConfigWithoutRepeats & {
    /**
...
export declare type SequenceItemObject<Value> = {
    value: Value;
    onDidAnimate?: (finished: boolean, maybeValue: Value | undefined, info: {
        attemptedSequenceArray: Value;
        attemptedSequenceItemValue: Value;
    }) => void;
} & TransitionConfigWithoutRepeats;
export declare type SequenceItem<Value> = // raw style values
Value | SequenceItemObject<Value>;
export declare type StyleValueWithSequenceArraysWithoutTransform<T> = {
...
export declare type StyleValueWithSequenceArraysWithTransform = {
    transform: StyleValueWithSequenceArrays<Transforms>[];
};
export declare type StyleValueWithSequenceArrays<T> = Partial<StyleValueWithSequenceArraysWithoutTransform<T> & StyleValueWithSequenceArraysWithTransform>;
export declare type OnDidAnimate<Animate = ImageStyle & TextStyle & ViewStyle, Key extends keyof Animate = keyof Animate> = (
/**
...
export declare type StyleValueWithReplacedTransforms<StyleProp> = Omit<StyleProp, keyof Transforms> & MotiTranformProps;
...
declare type OrDerivedValue<T> = T | DerivedValue<T>;
...
export declare type MotiTransitionProp<Animate = FallbackAnimateProp> = OrDerivedValue<MotiTransition<Animate>>;
export declare type InlineOnDidAnimate<Value> = (
/**
 * `boolean` inidcating whether or not the animation finished.
 */
finished: boolean, 
...
declare type ExcludeArrayType<T> = T extends (infer U)[] ? never : T;
declare type ExcludeObject<T> = T extends object ? never : T;
declare type StyleValueWithCallbacks<Animate> = {
    [Key in keyof Animate]?: Animate[Key] | {
        value: ExcludeObject<ExcludeArrayType<Animate[Key]>>;
        onDidAnimate: InlineOnDidAnimate<Animate[Key]>;
    };
};
export interface MotiProps<AnimateType = ImageStyle & TextStyle & ViewStyle, AnimateWithTransforms = StyleValueWithReplacedTransforms<AnimateType>, AnimateWithSequences = StyleValueWithSequenceArrays<AnimateWithTransforms>, Animate = StyleValueWithCallbacks<AnimateWithSequences>> {
    /**
     ...
     *
     */
    exitTransition?: MotiTransitionProp<AnimateWithTransforms> | ((custom?: any) => MotiTransition<AnimateWithTransforms>);
    /**
...
export declare type InternalControllerState<V> = number | V[keyof V];
export declare type Variants<V, AnimateType = ImageStyle & TextStyle & ViewStyle, AnimateWithTransformsAndTransition = StyleValueWithReplacedTransforms<AnimateType> & WithTransition, Animate = StyleValueWithSequenceArrays<AnimateWithTransformsAndTransition>> = {
    [key in keyof V]?: Animate;
} & {
    to?: Animate;
    from?: AnimateWithTransformsAndTransition;
};
export declare type UseAnimationState<V> = {
    /**
...
export declare type UseAnimationStateConfig<Variants, FromKey extends keyof Variants = keyof Variants, ToKey extends keyof Variants = keyof Variants> = {
    /**
...
export declare type WithTransition = {
    transition?: MotiTransition;
};
/**
 * Used for `useDynamicAnimation`
 */
export declare type DynamicStyleProp<AnimateType = ImageStyle & ViewStyle & TextStyle, AnimateWithTransforms = StyleValueWithReplacedTransforms<AnimateType>> = NonNullable<StyleValueWithSequenceArrays<AnimateWithTransforms>> & WithTransition;
export declare type UseDynamicAnimationState<Animate = FallbackAnimateProp> = {
    /**
     * @private
...
export declare type ExcludeFunctionKeys<T> = {
